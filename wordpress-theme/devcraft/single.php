            ...
            <article data-aos="fade-up">
                <header class="mb-12">
                    <div class="flex items-center gap-4 mb-6">
                        <span class="px-4 py-1 bg-orange-50 text-orange-500 rounded-full text-xs font-bold uppercase tracking-widest">
                            <?php the_category(', '); ?>
                        </span>
                        <span class="text-gray-400 text-sm font-medium"><?php echo get_the_date(); ?></span>
                    </div>
